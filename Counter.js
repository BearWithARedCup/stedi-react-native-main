...
export default function Counter() {
  ...
  const tallyLatestSteps = () => {
    console.log(
      "RecentAccelerationData: " +
        JSON.stringify(recentAccelerationData.current)
    );
    ...
    console.log(
      "Spikes: " + JSON.stringify(spikes) + " with length: " + spikes.length
    );
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.text}>steps: {stepCount}</Text>
